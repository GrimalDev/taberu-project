...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    redirect('https://project.baptistegrimaldi.info/connection');
    exit;
}
...
function cardTemplate($title, $description, $stars) {
    echo '<a class="generated-card" href=https://project.baptistegrimaldi.info/modifier-recette?recipes='.urlencode($title).'>
            <h2>'.$title.'</h2>
            <h3>'.$description.'</h3>
            <h4>'.$stars.'</h4>
          </a>';
