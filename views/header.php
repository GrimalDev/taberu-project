        ...
        <div>
            <?php
                ...
                if(isset($_SESSION["loggedin"]) || $_SESSION["loggedin"]){
                    echo '<a id="deconnect-nav" href="https://project.baptistegrimaldi.info/logout" class="underlined">Se deconnecter</a>';
                }
            ?>
            <a href="https://project.baptistegrimaldi.info/" class="underlined <?php active('');?>">Accueil</a>
            <a href="https://project.baptistegrimaldi.info/recettes" class="underlined <?php active('recettes');?>">Recettes</a>
            <a href="https://project.baptistegrimaldi.info/forum" class="underlined <?php active('forum');?>">Forum</a>
            <a href="https://project.baptistegrimaldi.info/compte" class="underlined <?php active('compte');?>">Compte</a>
            <div id="burger-container">
                ...
                <nav id="burger-nav">
                    <?php
                        if(isset($_SESSION["loggedin"]) || $_SESSION["loggedin"]){
                            echo '<a id="deconnect-burger" href="https://project.baptistegrimaldi.info/logout" class="underlined">Se deconnecter</a>';
                        }
                    ?>
                    <a href="https://project.baptistegrimaldi.info/" class="underlined <?php active('');?>">Accueil</a>
                    <a href="https://project.baptistegrimaldi.info/recettes" class="underlined <?php active('recettes');?>">Recettes</a>
                    ...
                    <?php
                        if(isset($_SESSION["loggedin"]) || $_SESSION["loggedin"]){
                            echo '<a href="https://project.baptistegrimaldi.info/modifications" class="underlined">modifications</a>';
                        }
                    ?>
                </nav>
            </div>
